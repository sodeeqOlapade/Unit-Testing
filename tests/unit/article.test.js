...
describe("Object testing", () => {
  ...
  it("checks if the received object is same as the expected object", () => {
    expect(obj).toEqual({
      name: "John Doe",
      age: "19",
      gender: "Male",
  ...
  it("checks if the received object has the name property and if value of name is John Doe", () => {
    expect(obj).toHaveProperty("name", "John Doe");
  });
  it("checks if the received object has property gender, not minding the value of gender", () => {
